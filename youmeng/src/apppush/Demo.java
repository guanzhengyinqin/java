...
import apppush.android.AndroidBroadcast;
import apppush.android.AndroidGroupcast;
import apppush.android.AndroidUnicast;
import apppush.ios.IOSBroadcast;
import apppush.ios.IOSGroupcast;
import apppush.ios.IOSUnicast;
...
public class Demo {
	 ...
	 * them if there are // multiple alias. // And if you have many alias, you
	 * can also upload a file containing // these alias, then // use file_id to
	 * send customized notification. String fileId =
	 * client.uploadContents(appkey, appMasterSecret, "aa" + "\n" + "bb" + "\n"
	 * + "alias"); customizedcast.setFileId(fileId, "alias_type");
	...
	/*
	 * public void sendAndroidFilecast() throws Exception { AndroidFilecast
	 * filecast = new AndroidFilecast(appkey, appMasterSecret); // TODO upload
	 * your device tokens, and use '\n' to split them if there // are multiple
	 * tokens String fileId = client.uploadContents(appkey, appMasterSecret,
	 * "aa" + "\n" + "bb"); filecast.setFileId(fileId);
	 * filecast.setTicker("Android filecast ticker");
	 * filecast.setTitle("中文的title"); filecast.setText("Android filecast text");
